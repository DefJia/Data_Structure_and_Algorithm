...
Status LocateElem(SqList L, ElemType e, Status(*compare)(ElemType, ElemType)){	//在L中查找与元素 e 满足compare() 的第 1 个元素
...
int main()
{
	...
	InitList(Lb);
	//====================================================
	printf("input the size of A:");    //读入集合A
	scanf("%d", &n);		
	...
	printf("input the size of B:");     //读入集合B
	scanf("%d", &n);		
